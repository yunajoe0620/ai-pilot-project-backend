...
//       console.log('주관식', shortProblem, '객관식', multipleChoiceProblem);
...
//         console.log('객관식결과입니다', result);

//         const cleanedText = result
//           .replace(/^```html\s*/, '')
//           .replace(/```$/, '');

//         fs.writeFile('multipletest.html', cleanedText, 'utf8', (err) => {
//           if (err) {
//           } else {
//             console.log('✅ 파일 저장 완료: manual.html');
//           }
